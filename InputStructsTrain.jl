...
Base.@kwdef mutable struct InputStruct
    model_runname::String="none"            # model runname
    sub_runname::String="none"              # model subruname; used in testing agents
...
Base.@kwdef mutable struct DQNParam
    ...
    save_ntwk_freq::Int64=500_000       # frequency (episodes) at which to save neural network (deault=1000)
    ...
    n_steps_decay::Int64=1_000_000        # number of steps (or episodes) to decay epsilon to minimum
